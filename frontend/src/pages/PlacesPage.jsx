    ...
    return(
        <div>
            <AccountNav />
                ...
                <Link className=" inline-flex gap-1 bg-blue-500 text-white py-2 px-6 rounded-full" to={'/account/places/new'}>
                ...
                <div className="mt-4"> 
                    {places.length > 0 && places.map(place => (
                        ...
                        {place.photos?.length > 0 && (
                            ...
                            <div className="p-2">
                                <h2 className=" px-2 mt-2 text-lg font-semibold">{place.title}</h2>
