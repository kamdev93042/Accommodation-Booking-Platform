    ...
    return(
     <header className=' flex justify-between'>
        <Link to="/" className='flex items-center gap-1'>
             <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 -rotate-90 text-sky-600">
              <path strokeLinecap="round" strokeLinejoin="round" d="M6 12 3.269 3.125A59.769 59.769 0 0 1 21.485 12 59.768 59.768 0 0 1 3.27 20.875L5.999 12Zm0 0h7.5" />
            </svg>
            <span className='font-bold text-xl text-sky-600'>Bodezy</span>
        </Link>
        ...
        <div className='flex gap-2 border border-grey-300 rounded-full py-2 px-4 shadow-md shadow-gray-300'>
            ...
            <div className='border-l border-gray-300'></div>
            <div>Add guests</div>
            <button className='bg-sky-600 text-white p-1 rounded-full'> 
